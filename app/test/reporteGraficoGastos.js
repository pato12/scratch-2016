...
QUnit.test( "testing al reporteGraficoController", function( assert ) {
  ...
  var c1 = new categoria("salario", "bla", false, "ingreso");
  var c2 = new categoria("regalo", "bla", false, "egreso");

  c1.save();
  c2.save();

  var movement1 = new movement(30, new Date(2016, 11, 7).toString(), "motivo blabla", c1.id, "ingreso");
  var movement2 = new movement(100, new Date(2016, 11, 8).toString(), "motivo blabla", c1.id, "ingreso");
  var movement3 = new movement(40, new Date(2016, 11, 8).toString(), "motivo blabla", c2.id, "egreso");
  var movement4 = new movement(40, new Date(2016, 11, 8).toString(), "motivo distinto", c2.id, "egreso");
  ...
  var resultadoEsperado = [
                            {key: "salario", values: [[fecha1, 30], [fecha2, 130]]},
                            {key: "regalo", values: [[fecha1, 0], [fecha2, -80]]}
                          ];
